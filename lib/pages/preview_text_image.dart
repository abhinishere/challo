...
class PreviewTextImage extends StatefulWidget {
  final bool whetherfromtextpost;
  ...
  const PreviewTextImage({
    required this.whetherfromtextpost,
  ...
  @override
  State<PreviewTextImage> createState() => _PreviewTextImageState();
}

class _PreviewTextImageState extends State<PreviewTextImage> {
  ...
  settingthingsup() async {
    if (widget.whetherfromtextpost == true) {
      ...
      infoDescription = textdoc['description'];
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                InkWell(
                  onTap: () => ShareService.shareContent(widget.docName,
                      'textpost', infotext, infoDescription, imageUrl),
                  child: Padding(
                    padding: const EdgeInsets.all(5.0),
                    child: Row(
                      children: [
  ...
  Widget arrowbackWidget() {
    return ButtonTheme(
      ...
      child: TextButton(
        onPressed: () {
          if (widget.whetherfromtextpost == false) {
            setState(() {
              hidenav = false;
            });
